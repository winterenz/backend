...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.AlumniListByJurusanResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/model.PekerjaanListByAlumniResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
        ...
        "/users/{user_id}/upload/foto": {
            "post": {
                ...
                "parameters": [
                    {
                        "type": "string",
                        "description": "User ID (Admin: bisa upload untuk semua user_id, User: gunakan 'me' atau user_id sendiri)",
                        "name": "user_id",
                        "in": "path",
                        "required": true
                    },
                    {
                        "type": "file",
                        "description": "Foto (maks 1MB, format: jpeg/png/jpg)",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    }
        ...
        "/users/{user_id}/upload/sertifikat": {
            "post": {
                ...
                "parameters": [
                    ...
                    {
                        "type": "file",
                        "description": "Sertifikat (maks 2MB, format: pdf)",
                        "name": "file",
                        "in": "formData",
                        "required": true
                    }
    ...
    "definitions": {
        ...
        "model.AlumniListByJurusanResponse": {
            "type": "object",
            "properties": {
                "count": {
                    "type": "integer"
        ...
        "model.FileUploadResponse": {
            ...
            "properties": {
                "data": {
                    "$ref": "#/definitions/model.FileUploadData"
                },
                "message": {
                    "type": "string"
                },
        ...
        "model.PekerjaanListByAlumniResponse": {
            "type": "object",
            "properties": {
                "count": {
                    "type": "integer"
